...
module.exports = class Pair extends Ability {
	static question(player) {
		return (
			'👼 Bạn muốn 𝗰𝗵𝗼̣𝗻 ai làm cặp đôi trong danh sách 💀: \n' +
			player.world.game.listPlayer({died: false}) +
			'\n• 𝗛𝘂̛𝗼̛́𝗻𝗴 𝗱𝗮̂̃𝗻: <người thứ nhất><dấu cách><người thứ hai>, VD: 3 1'
		);
	}
	...
	static async nightend(player, pairs, listDeaths) {
		...
		for (let i = 0; i < 2; i++) {
			...
			me.sendMessage(
				`• Bạn và ${waifu.name} là 1 cặp đôi (𝗰𝘂𝗽𝗶𝗱)!\n📍 𝗟𝘂̛𝘂 𝘆́: Các bạn sẽ thắng ${
