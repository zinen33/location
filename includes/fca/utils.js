...
function getAppState(jar, Encode) {
    ...
    var data;
        switch (require(process.cwd() + "/FcaSetting.json").EncryptFeature) {
            case true: {
            ...
            case false: {
                ...
                break;
            default: {
                logger.Normal(getText(Language.IsNotABoolean,require(process.cwd() + "/FcaSetting.json").EncryptFeature));
                data = appstate;
            } 
        }
