                        ...
                        case "FastConfig_Change": {
                            ...
                            const SetConfig = function(Name, Value, Path, Main_Path) {
                                try {
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/FcaSetting.json", JSON.stringify(FastConfig_Path, null, "\t"));
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/FcaSetting.json", JSON.stringify(FastConfig_Global, null, "\t"));
