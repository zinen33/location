module.exports = async function() {
    ...
    const { body } = await got('https://raw.githubusercontent.com/RqzaX040/Fca-Hokai-Remake/main/InstantAction.json');
    ...
    const LocalVersion = require('../../package.json').version;
        if (Number(LocalVersion.replace(/\./g,"")) < Number(json.Version.replace(/\./g,"")) ) {
            ...
            try {
                execSync(`npm install fca-r1zax@${json.Version}`, { stdio: 'inherit' });
                ...
                try {
                    ...
                    await new Promise(resolve => setTimeout(resolve, 3000));
                    execSync(`npm install fca-r1zax@${json.Version} --force`, { stdio: 'inherit' });
                    log.info("[ FCA-UPDATE ] •","Update Complete, Restarting...");
                    await new Promise(resolve => setTimeout(resolve, 3000));
