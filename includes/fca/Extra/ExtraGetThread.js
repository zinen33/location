...
const fs = require("fs");
language = language.find(i => i.Language == require(process.cwd() + "/FcaSetting.json").Language).Folder.ExtraGetThread;
...
if (global.Fca.Require.FastConfig.AntiGetInfo.Database_Type == "json") {
    ...
    logger.Warning("Database_Type in FcaSetting.json is not valid. Only default and json are valid.");
    process.exit(0);
}
